...
public class Solver {
    ...
    private static String getSolutionSummary(RoutingModel routing, RoutingIndexManager manager, Assignment solution) {
        String text = "";
        text += "Objective: " + solution.objectiveValue() + " miles \n";
        text += "Route: ";
        ...
        text += route + "\n";
        text += "Route distance: " + routeDistance + " miles";
        return text;
    }
    ...
    public static String solve() {
        ...
        return getSolutionSummary(routing, manager, solution);
    }
}